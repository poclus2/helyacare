...
export default function CraveControlPage() {
  ...
  const prices = PRODUCT_PRICES["helya-hydrate"];
            ...
            <div className="lg:col-span-5">
              <div className="lg:sticky top-24 pt-2 lg:pt-0 max-w-[460px]">
                ...
                <p className={`text-[15px] text-gray-900 mb-6 leading-relaxed ${inter.className}`}>
                  Électrolytes premium enrichis en minéraux essentiels. Conçu pour une hydratation cellulaire optimale, il soutient la récupération physique et maintient l'équilibre hydrique pendant vos journées les plus actives.*
                </p>
