...
export default function CraveControlPage() {
  ...
  const prices = PRODUCT_PRICES["pack-bien-etre"];
            ...
            <div className="lg:col-span-5">
              <div className="lg:sticky top-24 pt-2 lg:pt-0 max-w-[460px]">
                ...
                <p className={`text-[15px] text-gray-900 mb-6 leading-relaxed ${inter.className}`}>
                  L'alliance ultime pour votre métabolisme. Ce pack combine Crave Control pour la gestion de l'appétit et Helya Hydrate pour une hydratation cellulaire profonde. Maximisez vos résultats avec cette synergie validée cliniquement.*
                </p>
