...
export default function CraveControlPage() {
  ...
  const prices = PRODUCT_PRICES["helya-vigor"];
            ...
            <div className="lg:col-span-5">
              <div className="lg:sticky top-24 pt-2 lg:pt-0 max-w-[460px]">
                ...
                <p className={`text-[15px] text-gray-900 mb-6 leading-relaxed ${inter.className}`}>
                  Formule vitalité et énergie. À base de plantes adaptogènes et de vitamines B, Helya Vigor soutient votre endurance physique et mentale, vous aidant à rester performant tout au long de la journée sans crash.*
                </p>
