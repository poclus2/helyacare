            ...
            <div className="lg:col-span-5">
              <div className="lg:sticky top-24 pt-2 lg:pt-0 max-w-[460px]">
                ...
                <p className={`text-[15px] text-gray-900 mb-6 leading-relaxed ${inter.className}`}>
                  Un shot de satiété instantané. Formulé à base de pectine de pomme et de plantes adaptogènes, il calme les envies de grignoter entre les repas tout en apportant une dose de vitamines essentielles.*
                </p>
