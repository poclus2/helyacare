...
export default function CraveControlPage() {
  ...
  const prices = PRODUCT_PRICES["helya-perform"];
            ...
            <div className="lg:col-span-5">
              <div className="lg:sticky top-24 pt-2 lg:pt-0 max-w-[460px]">
                ...
                <p className={`text-[15px] text-gray-900 mb-6 leading-relaxed ${inter.className}`}>
                  Protocole performance avancé pour les sportifs de haut niveau. Formulé pour optimiser la récupération musculaire, augmenter la clarté mentale sous effort et soutenir les fonctions cognitives supérieures.*
                </p>
                ...
                <div className="mb-4 space-y-3">
                  <div className="flex items-center gap-2 px-4 py-2.5 bg-amber-50 border border-amber-200 rounded-xl">
                    <span className="text-amber-600 font-bold text-xs uppercase tracking-widest">🔔 Bientôt disponible</span>
                  </div>
                  <AddToCartButton
                    productKey="helya-perform"
