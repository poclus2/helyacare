...
exports.WithdrawalRequestedTemplate = void 0;
const base_template_1 = require("./base.template");
const WithdrawalRequestedTemplate = (name, amount, currency) => {
    const content = `
        <p>Hello ${name},</p>
    ...
    `;
    return (0, base_template_1.BaseEmailTemplate)('Withdrawal Request Received', content);
};
exports.WithdrawalRequestedTemplate = WithdrawalRequestedTemplate;
//# sourceMappingURL=withdrawal-requested.template.js.map